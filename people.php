	  ...
	  <div class="innerdiv">
		...
		<tbody>
		  <tr>
			...
			<p class="desc">Cell Biology.<br/>Cytoskeleton and motility.</p>
		      </div>
		    </td>
		    <td>
		      <!-- Matt Walker -->
		  ...
		  <tr>
                    ...
                    <td>
                      <!-- Steve Partin -->
                      <div class="personCell">
                        <h3> Admin. Associate</h3>
                        <img class="personImg" alt="Steve Partin" src="img/johndoe.png"/>
                        <p><strong>Steve Partin</strong></p>
                        <a href="mailto:spartin@email.unc.edu" target="_blank">spartin@email.unc.edu</a>
                        <p class="desc">Administrative Duties.</p>
                      </div>
                    </td>
                    <td/>
                    <td/>
